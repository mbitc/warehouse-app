...
import PickingPage from './pages/PickingPage/PickingPage';
      ...
      <Router>
        <Routes>
          ...
          <Route element={<WithNav />}>
            ...
            <Route path={`${ROOT_PATH}picking`} element={<PickingPage />} />
            ...
            <Route
              path={`${ROOT_PATH}catalog/:id`}
              element={<ProductsPage />}
            />
            <Route
              path={`${ROOT_PATH}catalog/item/:id`}
              element={<ItemPage />}
            />
          </Route>
        </Routes>
